...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/05/21 12:41:08 by ttanaka           #+#    #+#             */
/*   Updated: 2025/05/21 13:05:46 by ttanaka          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

void	rotate_ab_stack(t_score_info *target_info, t_list_info *info_a,
		t_list_info *info_b)
{
...
int	insertor(t_list_info *info_a, t_list_info *info_b)
{
	...
	while (info_b->head)
	{
		score_info = (t_score_info *)malloc(sizeof(t_score_info)
				* info_b->size);
		if (!score_info)
		{
