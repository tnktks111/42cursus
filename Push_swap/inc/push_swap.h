...
/*   Updated: 2025/05/21 19:17:41 by ttanaka          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void							separator(t_list_info *info_a,
									t_list_info *info_b);
int								insertor(t_list_info *info_a,
									t_list_info *info_b);
...
void							rotate(t_list_info *info, t_bool reverse,
									t_commands cmd);
void							rotate_two_stack(t_list_info *info_a,
									t_list_info *info_b, t_commands cmd);
...
void							gen_score_info(t_list_info *info_a,
									t_list_info *info_b,
									t_score_info score_info[]);
void							calc_min_score(t_score_info *score_info);
int								calc_min_score_idx(t_score_info score_info[],
									int size);
void							set_rotate_cnt(t_score_info *score_info, int a,
									int b, int ab);
...
long							*list_to_array(t_circ_doubly_list *head,
									int size);
int								find_insert_point(long *array, int size,
									int target);
long							find_chunk_point(t_circ_doubly_list *head,
									int size);
...
long							quick_select(long array[], int left, int right,
									int k);
